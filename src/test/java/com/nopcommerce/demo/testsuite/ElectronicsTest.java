...
public class ElectronicsTest extends TestBase {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
       ...
       /* //2.18 Click on “REGISTER” tab
        ...
        sendTextToElement(By.xpath("//input[@id='Email']"),"smarttester1@gmail.com");
        sendTextToElement(By.xpath("//input[@id='Password']"),"tester12");
        ...
        checkout.inputFirstname("Smart");
        checkout.inputLastname("Tester");
        checkout.inputEmail("smarttester1@gmail.com");
        checkout.selectCountry("Canada");
        checkout.inputCity("Toronto");
        checkout.inputAddress1("3 Millcar Drive");
        checkout.inputPostalCode("M1B 6JZ");
        ...
        checkout.inputCardHolderName("Mr Smart Tester");
        checkout.inputCardNumber("5686 6648 1418 5420");
        checkout.selectExpireMonth("05");
        checkout.selectExpireYear("2025");
