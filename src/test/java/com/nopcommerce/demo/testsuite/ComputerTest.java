...
public class ComputerTest extends TestBase {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        computerPage.inputFirstname("Smart");
        computerPage.inputLastname("Tester");
        computerPage.inputEmail("smarttest@gmail.com");
        computerPage.selectCountry("Canada");
        computerPage.inputCity("Toronto");
        computerPage.inputAddress1("3 Millcar Drive");
        computerPage.inputPostalCode("M1B 6J5");
        computerPage.inputPhoneNumber("987654321");
        ...
        computerPage.inputCardHolderName("Mrs Smart Tester");
        computerPage.inputCardNumber("5385 6548 2589 5420");
        computerPage.selectExpireMonth("10");
        computerPage.selectExpireYear("2026");
        computerPage.inputCardCode("369");
